  ...
  var Draw = function () {
      ...
      createClass(Draw, [{
          ...
          value: function destroyed() {
              ...
              this.el.removeEventListener(isTouch ? 'touchstart' : 'mousedown', this.onStart.bind(this), false);
              this.el.removeEventListener(isTouch ? 'touchmove' : 'mousemove', this.onMove.bind(this), false);
              this.el.removeEventListener(isTouch ? 'touchend' : 'mouseup', this.onEnd.bind(this), false);
          }
      }, {
          key: 'clear',
